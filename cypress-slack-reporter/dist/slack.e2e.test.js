...
describe('sends a slack message via a chat bot', () => {
    describe('with valid auth credentials ', () => {
        it('should send a message via a chat bot', () => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
            // arrange
            const testChatBotMessage = {
                channel: 'CESHQPXJ6',
            ...
            const chatBotClient = (0, slackClient_1.getChatBotClient)((_a = process.env.SLACK_TOKEN) !== null && _a !== void 0 ? _a : '');
            // act
            const res = yield (0, slackClient_1.sendViaBot)(testChatBotMessage, chatBotClient);
            expect(res).toEqual({
                ok: true,
